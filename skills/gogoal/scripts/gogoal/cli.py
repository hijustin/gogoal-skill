...
def build_parser(locale: str = "zh-CN") -> argparse.ArgumentParser:
    ...
    goal_update.add_argument("id", type=int)
    ...
    goal_block.add_argument("id", type=int)
    ...
    task_list.add_argument("--goal", type=int)
    ...
    task_create.add_argument("--goal", type=int, required=True)
    ...
    task_block.add_argument("id", type=int)
    ...
    task_cancel.add_argument("id", type=int)
    ...
    task_archive.add_argument("id", type=int)
    ...
    log_list.add_argument("--limit", type=int, default=20)
    log_list.add_argument("--goal", type=int)
    log_list.add_argument("--entity", choices=("goal", "ai", "user"))
    log_list.add_argument("--id", type=int)
    ...
    log_show.add_argument("id", type=int)
